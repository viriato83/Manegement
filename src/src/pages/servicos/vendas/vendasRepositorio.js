...
export class repositorioVenda{
    ...
    constructor(){
        this.endpoint ="http://localhost:8080/aquafish/vendas"
        this.mensagem= new mensagem();
        // this.token=sessionStorage.getItem("token");
        this.token="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJBcXVhZmlzaCIsInN1YiI6Ik11YmFpIiwiZXhwIjoxNzMzMzEzOTcwfQ.wt9PfKCd3BxQZM-WgdCUj8iXZ25okPlfa5ffvV7TzY4";
    }
